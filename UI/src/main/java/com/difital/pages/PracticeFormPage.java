...
public class PracticeFormPage extends BasePage{
    ...
    public PracticeFormPage fillFirstNameInput (String firstName){
        elementActions.writeText(firstNameInput, firstName);
        return this;
    }
    public PracticeFormPage fillLastNameInput (String lastName){
        elementActions.writeText(lastNameInput, lastName);
        return this;
    }
    public PracticeFormPage fillUserEmailInput(String userEmail){
        elementActions.writeText(userEmailInput, userEmail);
        return this;
    }
    ...
    public PracticeFormPage filUserNumberInput (String userNumber){
        elementActions.writeText(userNumberInput, userNumber);
        return this;
    }
    ...
    public PracticeFormPage fillCurrentAddressInput (String currentAddress){
    ...
    public PracticeFormPage UploadPicture() {
        elementActions.writeText(uploadPictureInput, "C:\\Users\\UserN\\Pictures\\Screenshots\\Foto1.png");
        return this;
    }

    public PracticeFormPage pressSubmitBtn(WebElement clickButton){
    ...
    public PracticeFormPage fillUpTheForm(Student student) throws InterruptedException, AWTException {
        ...
        fillFirstNameInput(student.getFirstName())
                ...
                .fillUserEmailInput(student.getEMail())
                .filUserNumberInput(student.getPhoneNumber())
                .fillCurrentAddressInput(student.getCurrentAddress())
                .clickHobbies()
                .clickGender()
                .UploadPicture()
                .selectSubject()
